        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('centerdepartment') }}"><b><span>Batch / Create Lots</span></b></a>
                </div>
            </div>
            <div class="top-right">
            ...
            <div class="row">
                ...
                <div class="col-md-4 float-left">
                           ...
                           <button type="button" class="btn btn-outline-secondary mt-1" data-bs-toggle="modal"
                                data-bs-target="#addpacketsModal">Create</button>
                </div>
                <div class="col-md-8 d-flex mt-1">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu mt-5 py-0" aria-labelledby="dropdownMenuButton">
                            <form action="{{ url('lot-search-date') }}" name="search" method="get">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       <td>{{ $loop->iteration}}</td>
                                         <td>
                                            <label class="form-check-label toggle_status" > {{ $ans->name }} Lot-{{ $ans->id }} </label>
                                        </td>
                                        <td>
                                            &nbsp;&nbsp;<a href="getPrint/{{ $ans->id}}"><i class="fa fa-print" aria-hidden="true"></i> </a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
