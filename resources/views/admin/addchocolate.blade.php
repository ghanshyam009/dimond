    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-header">
            ...
            <ul class="stockul">
                ...
                <li class="stockli mt-2 d-block d-md-inline-block"><a href="{{ url('addchocolate')}}">AddChocolate</a></li>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card-body card-block">
                                            ...
                                            <form action="{{ url('insertchocolatedashboard') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                {{ csrf_field() }}
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label class=" form-control-label">Machine No : </label></div>
                                                    <div class="col-12 col-md-9">
