                    ...
                    <div class="col-md-12 col-xs-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="row">
                               @foreach($data as $ans)
                                <div class="col-lg-3">
                                    <a href="{{ url('getstock') }}/{{ $ans['id'] }}">
                                      
                                    <div class="card">
                                        
                                        <div class="card-header">
                                            <strong>{{ $ans['name']}}</strong>
                                            <button type="button" class="btn btn-info btn-sm float-right">{{ $ans['pcs'] }}</button>
                                        </div>
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="row form-group1">
                                                    ...
                                                    <div class="col col-md-7"><label for="hf-email" class=" form-control-label font_size">Weight(Ct): {{ $ans['total_weight'] }}</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    ...
                                                    <div class="col col-md-7"><label for="hf-email" class=" form-control-label font_size">Avg.Weight(Ct): {{ $ans['avg_weight'] }}</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-5"><label for="hf-password" class=" form-control-label font_size"></label></div>
                                                    <div class="col col-md-7"><label for="hf-email" class=" form-control-label font_size">Avg.Height(Micron): {{ $ans['avg_height'] }}</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-5"><label for="hf-password" class=" form-control-label font_size"></label></div>
                                                    <div class="col col-md-7"><label for="hf-email" class=" form-control-label font_size">Avg.L*W: {{ $ans['avg_length'] }}*{{ $ans['avg_width'] }}</label></div>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
