...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-header">
            ...
            <ul class="stockul">
                <li class="stockli mt-2 d-block d-md-inline-block"><a href="{{ url('createlots') }}">Create Lot</a>
                </li>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="addpacketsModalLabel">Add Purity</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{ url('insertpurity') }}" method="post"
                    ...
                    <div class="col-6 col-md-7 ps-2 ps-md-0">
                        <div class="dropdown float-right float-md-left mr-3 mt-1">
                            ...
                            <div class="dropdown-menu mt-5 py-0" aria-labelledby="dropdownMenuButton">
                                <form action="{{ url('searchPurity') }}" name="search" method="get">
                                        ...
                                        @foreach ($data as $ans)
                                            <tr>
                                                ...
                                                <td> <button type="submit" class="btn btn-outline-secondary mt-1"><a
                                                            href="purityremove/{{ $ans->id }}"> Remove
                                                        </a></button></td>
