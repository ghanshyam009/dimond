...
<body>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <i class="fa fa-user-circle fa-2x according me-2" aria-hidden="true"></i>
                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="jangad" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row mt-5">
                                            ...
                                            <div class="card-body card-block">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-4"><label class=" form-control-label">Date
                                                            : </label></div>
                                                    <div class="col-12 col-md-8">
                                                        <input class="datetimepicker" type="datetime-local" required
                                        ...
                                        <button type="button" id="createjangad"
                                ...
                                <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                                            role="tab" aria-controls="home" aria-selected="true">Jangad Lines</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <script>
        $('#createjangad').click(function(e) {
            e.preventDefault();
            var formData = new FormData(document.getElementById("jangad"));
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': "{{ csrf_token() }}",
                },
                type: "POST",
                url: "{{ url('insertjangad') }}",
                data: formData,
                cache: false,
                processData: false,
                contentType: false,
