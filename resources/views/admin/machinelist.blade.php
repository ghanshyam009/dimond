...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-header">
            ...
            <ul class="stockul">
                <li class="stockli mt-2 d-block d-md-inline-block"><a href="{{ url('machinemanagement1') }}">Dashboard</a></li>
                <li class="stockli mt-2 d-block d-md-inline-block"><a href="{{ url('machine') }}">Machine</a></li>
                <li class="stockli mt-2 d-block d-md-inline-block"><a href="{{ url('machineequipments') }}">Machine Equipments</a></li>
            </ul>
        </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-6 col-md-6">
                        <a href="{{ url('machinelist') }}"><button type="button" class="btn btn-outline-secondary mt-1 float-right me-md-2 me-3"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
