    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-header">
            <strong class="card-title"><a href="{{ url('centerdepartment') }}"><i
                        class="fa-solid fa-table-columns"></i></a> <a href="{{ url('batch-module') }}">Batch</a></strong>
            <ul class="stockul">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="addpacketsModalLabel">Add Finish Type</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{ url('insertfinishtype') }}" method="post"
                    ...
                    <div class="col-6 col-md-7 ps-2 ps-md-0">
                        <div class="dropdown float-right float-md-left mr-3 mt-1">
                            ...
                            <div class="dropdown-menu mt-5 py-0" aria-labelledby="dropdownMenuButton">
                                <form action="{{ url('searchFinishType') }}" name="search" method="get">
                                        ...
                                        <tbody>
                                            @foreach ($data as $ans)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check-label toggle_status">
                                                            {{ $ans->name }} </label>
                                                    </td>
                                                    <td> <button type="submit"
                                                            class="btn btn-outline-secondary mt-1"><a
                                                                href="finishtyperemove/{{ $ans->id }}"> Remove
                                                            </a></button></td>
