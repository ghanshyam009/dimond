    ...
    <div id="right-panel" class="right-panel">
                                        ...
                                        <div class="stat-widget-five">
                                            ...
                                            <div class="stat-content">
                                                <div class="text-left dib">
                                                    <div class="stat-text"><span class="count">{{ count($a) }}</span></div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="stat-widget-five">
                                            ...
                                            <div class="stat-content">
                                                <div class="text-left dib">
                                                    <div class="stat-text"><span class="count">{{ count($b) }}</span></div>
                            ...
                            <div class="col-lg-4 col-md-6 col-xl-3">
                                    ...
                                    <div class="card card2">
                                        ...
                                        <div class="card-body card-block">
                                                    ...
                                                    <input type="hidden" value="{{ $data->id }}" id="machine_id_{{ $data->id }}"/>
                                                    <input type="hidden" value="{{ $data->timer }}" class="current_timer" id="old_timer_{{ $data->id }}"/>
                                                    <input type="hidden" value="{{ $data->stop_timer }}" class="current_stop_timer" id="stop_timer_{{ $data->id }}"/>
                                                    <div style="color: green;font-weight: bold;text-align: right;" id="timer_{{ $data->id }}">00:00:00</div>

                                                <div class="row form-group1">
                                                    <div class="col-12 col-md-4"><label for="hf-email" class=" form-control-label">Lot:</label></div>
                                                </div>
                                                <div class="row form-group mt-2 mt-md-2 mt-lg-0">
                                                    <div class="col-12 col-md-4"><label for="hf-password" class=" form-control-label">GH:{{ $data->growthrate }}</label></div>
                                                </div>
                                                <div class="row form-group1 mt-2">
                                                    <div class="col-10">
                                                        <div class="row">
                                                            @if($data->timer == null && $data->stop_timer == null)
                                                                <div class="col-6">
                                                                    <button id="start_{{ $data->id }}" class="start_machine_button btn btn-secondary btn-sm float-left mt-2"
                                                                        onclick="start({{ ($k+1) }})" style="font-size: 12px; padding: 3px;">Start</button>
                                                                </div>
                                                                <div class="col-6">
                                                                    <button type="button"
                                                                        class="btn btn-sm mt-2" style="padding: 0 5px;margin-top: 5px;">Draft</button>
                                                                </div>
                                                            @elseif($data->timer != null && $data->stop_timer != null)
                                                                <button disabled id="stop_machine{{ $data->id }}" class="stop_machine_button btn btn-secondary btn-sm float-left w-auto ms-2 mt-2"
                                                                    onclick="stop({{ $data->id }})" style="font-size: 12px; padding: 3px;">Growing Done</button>
                                                            @else
                                                                <div class="col-6">
                                                                    <button id="stop_machine{{ $data->id }}" class="stop_machine_button btn btn-secondary btn-sm float-left mt-2"
                                                                        onclick="stop({{ $data->id }})" style="font-size: 12px; padding: 3px;">Growing Done</button>
                                                                </div>
                                                                <div class="col-6 ps-3">
                                                                    <button type="button"
                                                                        class="btn btn-success btn-sm mt-2" style="font-size: 12px; padding: 3px;">In Progress</button>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-2">
                                                        <button type="button" class="btn btn-danger btn-sm float-right mt-2" style="font-size: 12px; padding: 3px 6px;">B</button>
                                                    </div>
                                                </div>
        ...
        <script>
            ...
            function timer(id) {
                ...
                //console.log("........................","timer_" + id);
                //console.log(timeArray[id]['dispHour'] + ":" + timeArray[id]['dispMin'] + ":" + timeArray[id]['dispSec']);
                $("#timer_" + id).html(timeArray[id]['dispHour'] + ":" + timeArray[id]['dispMin'] + ":" + timeArray[id]['dispSec']);
            ...
            function stop(id){
                ...
                //console.log(timeArray[id]['timeoutId']);
                ...
                $.ajax({
                    ...
                    success: function() {
                        //console.log("A");
                        $("#stop_machine"+id).attr("disabled", true);
                    }
                });
            }
            ...
            $(document).on('click', '.start_machine_button', function () {
                //console.log(this.id);
