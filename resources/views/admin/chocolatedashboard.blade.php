...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-header">
            ...
            <ul class="stockul">
                @if(Auth::check())
                    @if(Auth::user()->role == 'admin' || Auth::user()->role == 'manager' || Auth::user()->role == 'laser user' || Auth::user()->role == 'growing user')
                    ...
                    {{-- @endif --}}
                    @if(Auth::user()->role == 'admin' || Auth::user()->role == 'manager' || Auth::user()->role == 'cliving user' || Auth::user()->role == 'growing user')
...
{{-- 
        ...
        @if(Auth::check())
            @if(Auth::user()->role == 'admin' || Auth::user()->role == 'manager' || Auth::user()->role == 'growing user' || Auth::user()->role == 'cliving user')
                <div class="content">
                    <div class="animated fadeIn">
                        <div class="row">
                            <div class="col-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        ...
                                                        <input type="hidden" value="{{ $ans->timer }}"
                                                            class="current_timer" id="old_timer_{{ $ans->id }}" />
                                                        <input type="hidden" value="{{ $ans->stop_timer }}"
                                                            class="current_stop_timer" id="stop_timer_{{ $ans->id }}" />
                                                                ...
                                                                <div class="col-10">
                                                                    <div class="row">
                                                                        ...
                                                                        @elseif($ans->timer != null && $ans->stop_timer != null)
                                                                            <button disabled id="stop_{{ $ans->id }}"
