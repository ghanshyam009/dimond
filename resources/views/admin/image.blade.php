                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card-body card-block">
                                                    ...
                                                    @endif
                                                    <form action="{{ url('insertimages') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                        {{ csrf_field() }}
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-12 col-md-9" style="display:flex;">
                                                                <input type="file"  name="img1" required  accept="image/*" webcam>
                                                                <label class=" form-control-label pe-2">Chocolate Image2 :  </label>
                                                                <input type="file"  required name="img2" accept="image/*" webcam>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-12 col-md-9" style="display:flex;">
                                                                ...
                                                                <label class=" form-control-label pe-2">Chocolate Image4 :  </label>
                                                                <input type="file"  required name="img4" accept="image/*" webcam>
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col col-md-3"><label class=" form-control-label">Chocolate Image5 : </label></div>
                                                            <div class="col-12 col-md-9" style="display:flex;">
                                                                <input type="file"  name="img5" required  accept="image/*" webcam>
                                                    ...
                                                    <table id="bootstrap-data-table" class="table table-responsive-lg">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $ans->name }}</td>
                                                                <td><img src="{{url('item_img1')}}/{{$ans->image}}" style="width: 70px; height: 70px;"></td>
                                                                <td><img src="{{url('item_img2')}}/{{$ans->img2}}" style="width: 70px; height: 70px;"></td>
                                                                <td><img src="{{url('item_img3')}}/{{$ans->img3}}" style="width: 70px; height: 70px;"></td>
                                                                <td><img src="{{url('item_img4')}}/{{$ans->img4}}" style="width: 70px; height: 70px;"></td>
                                                                <td><img src="{{url('item_img5')}}/{{$ans->img5}}" style="width: 70px; height: 70px;"></td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
