                                    ...
                                    <div class="col-lg-12">
                                        <div class="card-body card-block">
                                            ...
                                            <form action="{{ url('insertendgrowing') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label class=" form-control-label">End Date : </label></div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="date" id="email-input" name="edate" value={{$now }} placeholder="edate.." required class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label class=" form-control-label">End Time : </label></div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="time" id="email-input" name="etime" value={{ $date }} placeholder="etime.." required class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label class=" form-control-label">Growing Hours : </label></div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="email-input" name="ghour" placeholder="growinghours.." required class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label class=" form-control-label">Chocolate Image : </label></div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="file"  name="img" accept="image/*" webcam>
                                                        <label class=" form-control-label pe-2">Chocolate Image :  </label>
                                                        <input type="file"  required name="img5" accept="image/*" webcam>
                                                    </div>
                                                </div>
                                                    ...
                                                    <table class="table" id="bootstrap-data-table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><img src="{{url('image')}}/{{$ans->machineimage}}" style="height: 70px; width: 70px;"></td>
                                                                <td><img src="{{url('image5')}}/{{$ans->img5}}" style="height: 70px; width: 70px;"></td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
