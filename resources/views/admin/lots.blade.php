                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                                            ...
                                            <form action="#" method="post" enctype="multipart/form-data"
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-12 col-md-2"><label
                                                            class=" form-control-label">Return Type</label></div>
                        ...
                        <div class="modal-footer float-left">
                            <button type="button" id="submitBtn" class="btn btn-secondary">Create</button>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card-body card-block">
                                            <form action="#" method="post" enctype="multipart/form-data"
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label for="select"
                                                            class=" form-control-label">Location : </label></div>
                                                    <div class="col-12 col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-body card-block">
                                            ...
                                            @endif
                                            <form action="{{ url('insertendgrowing') }}" method="post"
                                                enctype="multipart/form-data" class="form-horizontal">
                                                {{ csrf_field() }}
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label for="select"
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label class=" form-control-label">End
                                                            Date : </label></div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="date" id="email-input" name="edate"
                                                            value={{ $now }} placeholder="edate.." required
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label class=" form-control-label">End
                                                            Time : </label></div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="time" id="email-input" name="etime"
                                                            value={{ $date }} placeholder="etime.." required
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label
                                                            class=" form-control-label">Growing Hours : </label></div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="email-input" name="ghour"
                                                            placeholder="growinghours.." required
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        ...
                                                        <label class=" form-control-label pe-2">Chocolate Image :
                                                        </label>
                                                        <input type="file" required name="img5"
                                                            accept="image/*" webcam>
                                                    </div>
                                                </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($data as $ans)
                                                                <tr>
                                                                    ...
                                                                    <td><img src="{{ url('image') }}/{{ $ans->machineimage }}"
                                                                            style="height: 70px; width: 70px;"></td>
                                                                    <td><img src="{{ url('image5') }}/{{ $ans->img5 }}"
                                                                            style="height: 70px; width: 70px;"></td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
